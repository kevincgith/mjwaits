...
| 食叮 | 5 | `eatRiichi` is true **and** `riichi` isn't `"none"`. | — | Independent of 即食 - both can be declared at once, each contributing their own flat 5 tai. Same UI show/reset behavior as 即食. Also applies to all 3 special hands. |
