...
| 海底撈月 | 10 | Same shape as 河底撈魚, `lastTileWin === "sea-bottom"`. Won by self-drawing the very last tile in the wall. | — | Mutually exclusive with 河底撈魚/海底撈月(一筒) by construction. Also applies to all 3 special hands. **UI-only wiring** (see 自摸's own row): self-drawing the last wall tile is inherently a self-draw, so activating 海底撈月 forces 自摸 on (deactivating 搶槓/雙響/三響/地胡 with it); activating 自摸 forces 海底撈月 back to none if it was the reason 自摸 was on. Also mutually exclusive with 四子內/七子內/十子內 and 天胡/地胡/人胡, same as 河底撈魚. |
| 海底撈月(一筒) | 20 | Same shape as 河底撈魚, `lastTileWin === "sea-bottom-one-tong"` - 海底撈月 specifically when that final self-drawn tile is 1 Tong (`1t`). | — | Mutually exclusive with 河底撈魚/海底撈月 by construction. Also applies to all 3 special hands. Same 自摸, 四子內/七子內/十子內, and 天胡/地胡/人胡 UI wiring as 海底撈月. |
